...
class MLPPolicyPG(MLPPolicy):
    ...
    def update(self, observations, actions, advantages, q_values=None, N=None):
        ...
        if self.nn_baseline:
            ...
            assert baseline_predictions.shape == targets.shape, f"{baseline_predictions.shape}, {targets.shape}"
